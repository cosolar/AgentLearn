...
> 📅 内容同步至 **2026 年 10 月 1 日** 技术栈 · LangChain v1 · LangGraph 1.1 · MCP 2026-07-28 · **Agent Harness**

## 📖 项目简介

**AgentLearn** 是一份从零开始的 **AI Agent 学习教程**，旨在帮助开发者系统掌握 AI Agent 的核心概念、开发框架和实践技巧。

无论你是刚刚接触 AI Agent 的新手，还是有经验的开发者，都能在这里找到适合自己的内容。全部 **65+ 篇教程、~90 小时学习内容**，免费开源。
...
```
基础概念 → LangChain v1 实战 → LangGraph 工作流 → RAG 系统 → 协议与生态 → 生产部署 → Agent Harness
```
...
| ⑥ 驾驭 | 第 9 部分 | **Agent Harness 工程，构建可托付的生产级 Agent** |
...
| 🛠️ **第九部分：Agent Harness** | Agent=Model+Harness、十二大模块、权限沙箱、验证循环、实战、选型 | 12 |
